...
# 敏感标记（入库枚举；报废影像仅对后两者强制）
SENSITIVITY_NONE = "无"
SENSITIVITY_CONTROLLED = "管控"
SENSITIVITY_EXPORT = "出口管制"
SENSITIVITY_VALUES = (SENSITIVITY_NONE, SENSITIVITY_CONTROLLED, SENSITIVITY_EXPORT)
SENSITIVITY_REQUIRE_SCRAP_ATTACHMENT = (SENSITIVITY_CONTROLLED, SENSITIVITY_EXPORT)
